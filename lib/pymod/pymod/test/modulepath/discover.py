...
def test_modulepath_discover_bad_versioned_default(tmpdir):
    ...
    assert pymod.modulepath.discover.pop_versioned_default(a.strpath, ['.version']) is None
...
def test_modulepath_discover_versioned_default(tmpdir):
    ...
    a.join('1.0').write('')
    assert pymod.modulepath.discover.pop_versioned_default(a.strpath, ['1.0', '.version']) \
