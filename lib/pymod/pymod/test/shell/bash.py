...
class TestBashShell:
    ...
    def test_shell_bash_format_environment_variable(self):
        s = self.shell.format_environment_variable('VAR', 'VAL')
        assert s == 'VAR="VAL";\nexport VAR;'
        s = self.shell.format_environment_variable('VAR', None)
        assert s == 'unset VAR;'

    def test_shell_bash_format_shell_function(self):
    ...
    def test_shell_bash_format_alias(self):
    ...
    def test_shell_bash_source_command(self):
    ...
    def test_shell_bash_format_output(self):
        environ = Environ()
        environ.update(
